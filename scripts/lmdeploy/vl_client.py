        ...
        {'role': 'user',
         'content': [{'type': 'text',
                     ...
                     {'type': 'image_url',
                      ...
                      'image_url': {'url': f"data:image/jpeg;base64,{encode_image(img_url_list[1])}",}
#                      'image_url': {'url': img_url_list[1],},
                      }
                     ]
         }
    ...
    for output, usage, finish_reason in api_client.chat_completions_v1(
        ...
        if stream:
            ...
            print(output)
            print(f'\nprompt tokens: {usage["prompt_tokens"]}, generated tokens: {usage["completion_tokens"]}, finish reson: {finish_reason}')
    if stream:
